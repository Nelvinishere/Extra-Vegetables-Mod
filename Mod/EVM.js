G.AddData({
	...
	func:function()
	{
		...
		G.getDict('farmer').modes['plant spinach']={name:'plant spinach', desc: 'turns spoiled food, fruit seeds and water into strong to the finish spinach',req:{'farming':true},use:{'knapped tools':1}};
